...
public class CompareServletToJersey {

    public static String compare(String host, String port, String contextPath) {
        try {
    ...
    private static String servlet(String host, String port, String contextPath) throws IOException {
    ...
    private static String jersey(String host, String port, String contextPath) throws IOException {
