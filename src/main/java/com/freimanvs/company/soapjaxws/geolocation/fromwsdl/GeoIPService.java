    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.freimanvs.company.soapjaxws.geolocation.fromwsdl.GeoIPService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.freimanvs.company.soapjaxws.geolocation.fromwsdl.GeoIPService.class.getResource(".");
