    ...
    function getAll() {
        $.getJSON( "/employees", function( data ) {
            ...
            appendJson = appendJson + "<tr>"
                ...
                + "<td align=\"center\"><input name='add' type=\"text\" size='7' minlength='5' placeholder='должность'></td>"
            ...
            for (var i = 0; i < data.length; i++) {
                appendJson = appendJson + "<tr>"
                    ...
                    // + "<td align=\"center\">" + data[i].fio + "</td>"
                    // + "<td align=\"center\">" + data[i].department + "</td>"
                    ...
                    // + "<td>" + data[i].age + "</td>"
                    // + "<td><a href='/employees?method=delete&id=" + data[i].id + "' onclick=\"if (!(confirm('Are you sure you want to delete this customer?'))) return false\">удалить</a></td>"
                ...
                $("input[name='add']").each(function (index) {
                    ...
                    if (index == 3) {
                        if (validFivePlusSymbols($(this).val())) {
                            ...
                            alert("not valid department [5+ symbols]");
                            getAll();
                            valid = false;
                            return false;
                        }
